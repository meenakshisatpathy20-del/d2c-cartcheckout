...
let inventory = [
  ...
  },
  {
    ...
    mrp: 1899,
    stock: 3,
    image: "https://images.unsplash.com/photo-1552902865-b72c031ac5ea?w=300&q=80"
  },
  {
    id: "sku-swarg-03",
    brand: "Swarg Homes",
    ...
    mrp: 3999,
    stock: 2,
    image: "https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=300&q=80"
  }
];
...
app.post('/api/shiprocket/check-pincode', (req, res) => {
  ...
  res.json({
    ...
    estimatedDays,
    courierPartner: "Delhivery Air via Shiprocket",
    codAvailable: true,
    shippingFee: 50
  });
});
...
app.post('/api/coupons/validate', (req, res) => {
  ...
  res.json({ valid: true, code, discountAmount });
});
...
const PORT = 5000;
app.listen(PORT, () => console.log(`D2C Backend active on port ${PORT}`));